...
*/
class NEGOCIATEUR_BASE extends SQLComposer{
	// STATIC //
	private static $sTableName='negociateur';
  ...
  'prenomNegociateur' => 'TEXT',
  'nomNegociateur' => 'TEXT',
  'telephoneNegociateur' => 'TEXT',
  'emailNegociateur' => 'TEXT',
);
  ...
  'agence' => 
  array (
    'negociateur_agence_id' => 'agence_id',
  ),
);
  ...
  5 => 'emailNegociateur',
	...
	public function join_agence(){
		...
		$aSendsParams[]=array(array(agence::Field($sJoinTable.'.negociateur_agence_id')));
		$aSendsParams[]=array('=');
