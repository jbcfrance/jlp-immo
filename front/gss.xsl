...
<xsl:stylesheet version="2.0" 
        ...
        <table class="copyright" id="table_copyright">
          <tr>
            <td>
			  ...
			  Cpk-Web.com EstateXml Parser <a href="http://www.cpk-web.com" target="_blank">CpkWeb.com</a>
            </td>
          </tr>
        </table>
      </body>
  ...
  <xsl:template name="siteindexTable">
    <h3>This Google Sitemap file was generated automaticaly by the <a href="http://www.cpk-web.com" target="_blank">CpkWeb.com</a> EstateXml Parser.</h3>          
