 ...
 */
 define('FPDF_FONTPATH',INCLUDE_PATH.DIRECTORY_SEPARATOR.'pdf'.DIRECTORY_SEPARATOR.'font/');
include(INCLUDE_PATH.DIRECTORY_SEPARATOR.'pdf'.DIRECTORY_SEPARATOR.'fpdf.php');
include(INCLUDE_PATH.DIRECTORY_SEPARATOR.'pdf'.DIRECTORY_SEPARATOR.'color.inc.php');
include(INCLUDE_PATH.DIRECTORY_SEPARATOR.'pdf'.DIRECTORY_SEPARATOR.'htmlparser.inc.php');
